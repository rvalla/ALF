...
class LigetiStorm(m21Score):
	"A machine to make a Ligeti's piece"
	...
	def __init__(self, title, composer, key_signature, time_signature, parts, cycles, part_offset, \
		...
		self.cycles = cycles #El número de veces que corremos esto
		self.part_off = part_offset
		self.t_off = t_offset #La distancia temporal para el canon
		self.p_off = p_offset #La distancia interválica para el canon
